...
g1 <-  ggplot(Promedios)+
  ...
  ggtitle("Bioensayo de muestras externas Humik y Exuroot+ECCA's L1 (15Feb24)")+
...
g3 <- ggplot(Promedios)+
  ...
  ggtitle("Bioensayo de muestras externas Humik y Exuroot+ECCA's L2 (05Marzo24)")+
  theme(plot.title = element_text(hjust = 0.5, size = 18, color = "black", face = "bold"))+
  ylab("Longitud de raíz primaria")+
  theme(axis.text.x = element_text(angle=45,hjust=1, size = 13))+
  theme(axis.text.y = element_text(size = 13))+
...
```{r}
# Lotes 1 y 2 en un mismo gráfico para la variable de longitud:
...
ggplot(Prom_long, aes(x = Tratamiento, y = Longitud, fill = Lote))+
  ...
  ggtitle("Bioensayo de muestras externas Humik y Exuroot+ECCA'S Longitud")+
  theme(plot.title = element_text(hjust = 0.5, size = 18, color= "black", face = "bold"))+
  ...
  theme(axis.title.x = element_text(size = 15))+
  theme(axis.title.y = element_text(vjust = 3, size = 15))+
  scale_fill_manual(name = "Lote",values = c("#260F99", "#7EC3E5"))
