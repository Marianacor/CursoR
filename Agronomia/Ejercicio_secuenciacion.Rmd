...
bray_bdiv <- phyloseq::distance(Vid2, # especificamos que es la funcion distance del paquete de phyloseq ya que hay otra funcion con ese nombre
                                method = "bray",
                                type = "sample")
```
...
plot_composition(Proteo_ord, plot.type = "heatmap")+
  theme_bw()+
  scale_fill_gradient(low = "snow2", high = "blue")+
  coord_flip()
