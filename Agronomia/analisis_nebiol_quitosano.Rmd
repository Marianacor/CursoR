...
# DATA
Quitosano2 <- read.csv("~/CursoR/CursoRgit/Analisis bioensayos/Materiales/Quitosano_lateral_long.csv")
Quitosano3 <- read.csv("~/CursoR/CursoRgit/Analisis bioensayos/Materiales/Quitosano_promedios.csv")
Quitosano <- read.csv("~/CursoR/CursoRgit/Analisis bioensayos/Materiales/Quitosano.csv")
