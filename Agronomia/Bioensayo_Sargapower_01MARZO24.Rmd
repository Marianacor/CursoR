...
Muestras <- read.csv("~/CursoR/CursoRgit/Agronomia/Materiales/Bioensayo sargapower_long_lat.csv")

Variables <- read.csv("~/CursoR/CursoRgit/Agronomia/Materiales/Bioensayo sargapower_variables.csv")
```
