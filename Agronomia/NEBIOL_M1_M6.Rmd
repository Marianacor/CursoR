...
Bioensayo <- read.csv("~/CursoR/CursoRgit/Agronomia/Materiales/Bioensayo M1-M6.csv")
```
...
Prom_long$Tratamiento=factor(Prom_long$Tratamiento,levels=c("Control","NAA","GA3","M1 Directo", "M1 1:20","M1 1:50","M2 Directo", "M2 1:20","M2 1:50","M3 Directo","M3 1:20","M3 1:50", "M4 Directo","M4 1:20","M4 1:50", "M5 Directo", "M5 1:20", "M5 1:50", "M6 Directo", "M6 1:20", "M6 1:50"))
levels(Prom_long$Tratamiento)

levels(Prom_lat$Tratamiento)
Prom_lat$Tratamiento=factor(Prom_lat$Tratamiento,levels=c("Control","NAA","GA3","M1 Directo", "M1 1:20", "M1 1:50", "M2 Directo", "M2 1:20", "M2 1:50", "M3 Directo", "M3 1:20", "M3 1:50", "M4 Directo", "M4 1:20", "M4 1:50", "M5 Directo", "M5 1:20", "M5 1:50", "M6 Directo", "M6 1:20", "M6 1:50"))
levels(Prom_lat$Tratamiento)
...
g1 <- ggplot(Prom_long)+
  ...
  ggtitle("Bioensayo NEBIOL y extractos Lote #1 (17Enero24)")+
...
g3 <- ggplot(Prom_long)+
  ...
  ggtitle("Bioensayo NEBIOL y extractos Lote #2 (9Feb24)")+
  theme(plot.title = element_text(hjust = 0.5, size = 18, color = "black", face = "bold"))+
  ylab("Longitud de raíz primaria")+
  theme(axis.text.x = element_text(angle=45,hjust=1, size = 9))+
  theme(axis.text.y = element_text(size = 9))+
...
g5 <- ggplot(Prom_long)+
  ...
  ggtitle("Bioensayo NEBIOL y extractos Lote #3 (12Marzo24)")+
  theme(plot.title = element_text(hjust = 0.5, size = 18, color = "black", face = "bold"))+
  ylab("Longitud de raíz primaria")+
  theme(axis.text.x = element_text(angle=45,hjust=1, size = 9))+
  theme(axis.text.y = element_text(size = 9))+
