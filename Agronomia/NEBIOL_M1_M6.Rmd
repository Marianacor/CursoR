...
Lotes <- read.csv("~/CursoR/CursoRgit/Agronomia/Materiales/Long_Lateral_Nebiol M1-M6.csv")
...
Promedios <- Bioensayo %>%
  ...
  summarize(Long_lote1 = mean(Longitud.Lote.1, na.rm = TRUE),
            ...
            Lat_lote2 = mean(ifelse(Laterales.Lote.2==0, NA, Laterales.Lote.1), na.rm = TRUE),
            Desv_lat_L2 = sd(ifelse(Laterales.Lote.2==0, NA, Laterales.Lote.1), na.rm = TRUE),
            Error_desv_lat_L2 = std.error(ifelse(Laterales.Lote.2==0, NA, Laterales.Lote.1), na.rm = TRUE))
